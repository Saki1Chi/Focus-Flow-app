...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final subColor  = tokens?.textSub ?? (isDark ? const Color(0xFF484862) : const Color(0xFF9898B8));
...
class _RefreshButtonState extends State<_RefreshButton>
  ...
  void initState() {
    ...
    _rotation = Tween<double>(begin: 0, end: 1).animate(
      CurvedAnimation(parent: _rotCtrl, curve: Curves.easeOutCubic),
    );
  }
...
class _UnlockBadgeState extends State<_UnlockBadge>
  ...
  void initState() {
    ...
    _pulse = Tween<double>(begin: 0.6, end: 1.2).animate(
    ...
    return AnimatedBuilder(
      ...
      builder: (_, __) => Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
              color: widget.accent.withValues(alpha: 0.28), width: 1),
          boxShadow: [
            BoxShadow(
            ...
            AnimatedBuilder(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color: widget.accent.withValues(alpha: 0.22), width: 1),
                  boxShadow: [
                    BoxShadow(
                      color: widget.accent.withValues(alpha: 0.12),
                      blurRadius: 24,
                ...
                child: Icon(Icons.task_alt_rounded,
                    size: 36, color: widget.accent.withValues(alpha: 0.7)),
              ),
            ),
